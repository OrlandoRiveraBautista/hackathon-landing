...
const dictionary: Dictionary = {
  ...
  onsiteSelection: {
    ...
    boostButtonMaxed: "MAX BOOST REACHED",
    boostTapHint: "First tap locks in 3× weight, each extra tap adds +1 — max 1,000 taps",
    boosting: "SAVING...",
    ...
    errors: {
      ...
      boostLimitReached: "You've reached the maximum boost taps.",
      generic: "Something went wrong. Try again.",
    },
  },
  legal: {
