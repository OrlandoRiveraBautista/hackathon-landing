...
const dictionary: Dictionary = {
  ...
  hero: {
    ...
    signInPrompt: "Already on the waitlist?",
    signIn: "Sign in to your member portal",
  },
  about: {
    label: "THE MISSION",
  ...
  shirt: {
    ...
    accentWord: "Shirt",
    body: "Every on-site participant gets an exclusive Build Pa'l Norte tee. Pick your size when you boost your spot — or choose it when you join the waitlist.",
    hint: "Unisex fit · Sizes XS through XXL",
    sizeLabel: "SELECT YOUR SIZE",
    saveButton: "SAVE SIZE",
    savingButton: "SAVING…",
    savedMessage: "Size saved — you're all set!",
    registerCta: "JOIN WAITLIST",
    registerHint: "You'll pick your shirt size during registration.",
    signInPrompt: "Sign in to save your shirt size.",
    signInCta: "SIGN IN",
    currentSize: "Saved: {size}",
    expandImage: "View shirt design full screen",
    closeImage: "Close",
  },
  perks: {
    label: "WHAT YOU GET",
  ...
  waitlist: {
    ...
    shirtSizePlaceholder: "Select your size",
    join: "REGISTER",
    joining: "REGISTERING...",
    close: "CLOSE",
    ...
    errors: {
      ...
      invalidShirtSize: "Please select your shirt size.",
  ...
  members: {
    ...
    directory: {
      ...
      addToTeam: "Invite to team",
      addingToTeam: "Sending...",
      added: "On your team",
      inviteSent: "Invite sent",
      alreadyInTeam: "Already in a team",
      teamFull: "Team is full",
      addFailed: "Could not add member. Try again.",
    },
    platformFooter: {
  ...
  notifications: {
    metaTitle: "Notifications — Build Pa'l Norte",
    metaDescription: "Team invites and updates for Build Pa'l Norte.",
    eyebrow: "NOTIFICATIONS",
    title: "Your notifications",
    panelTitle: "NOTIFICATIONS",
    viewAll: "View all notifications",
    subtitle: "Review team invites. You can only join one team.",
    emptyTitle: "All caught up",
    emptySubtitle: "No pending team invites right now.",
    inviteMessage: "{captain} invited you to join {team}",
    accept: "Accept",
    decline: "Decline",
    accepting: "Accepting...",
    declining: "Declining...",
    acceptedBanner: "You joined the team!",
    declinedBanner: "Invite declined.",
    backToHome: "← Back to dashboard",
    errors: {
      generic: "Something went wrong. Try again.",
      alreadyInTeam: "You're already in a team.",
      teamFull: "That team is full.",
      inviteExpired: "This invite is no longer available.",
    },
  },
  profile: {
    ...
    shirtSize: "SHIRT SIZE",
    shirtSizeEmpty: "Not selected yet",
    shirtSizeHint: "Unisex fit — we'll use this for your hackathon shirt.",
    interests: "INTERESTS",
    ...
    skillsHint: "Press Enter or comma to add each skill — up to 20 tags.",
    aboutSection: "ABOUT",
    ...
    errors: {
      ...
      invalidShirtSize: "Please select a valid shirt size.",
      generic: "Something went wrong. Try again.",
      saveFailed: "Could not save your profile. Try again.",
    },
  },
  team: {
    metaTitle: "My Team — Build Pa'l Norte",
    metaDescription: "Create or manage your hackathon team and submit your project on Build Pa'l Norte.",
    eyebrow: "MY TEAM",
    noTeamTitle: "You're not in a team yet",
    noTeamSubtitle: "Create a team to organize your crew and submit your project for the hackathon.",
    createTeamLabel: "CREATE A TEAM",
    teamNameLabel: "TEAM NAME",
    teamNamePlaceholder: "e.g. Atomic Builders",
    teamDescriptionLabel: "DESCRIPTION",
    teamDescriptionPlaceholder: "What are you building? (optional)",
    suggestName: "Suggest a name",
    openToJoin: "Open to new members",
    openToJoinHint: "Allow other builders to request to join your team.",
    ...
    leavingTeam: "Leaving...",
    projectLabel: "PROJECT SUBMISSION",
    projectSubtitle: "Share your GitHub repo and project details for judging.",
    noProjectSubtitle: "Add your GitHub repo to register your project for judging.",
    githubUrlLabel: "GITHUB REPO URL",
    githubUrlPlaceholder: "https://github.com/your-org/your-repo",
    githubUrlHint: "Must be a public repository.",
    projectTitleLabel: "PROJECT TITLE",
    projectTitlePlaceholder: "What did you build?",
    projectDescriptionLabel: "DESCRIPTION",
    projectDescriptionPlaceholder: "What problem does it solve?",
    techStackLabel: "TECH STACK",
    techStackPlaceholder: "Add a technology...",
    techStackHint: "Press Enter or comma to add each tag.",
    demoUrlLabel: "DEMO LINK",
    demoUrlPlaceholder: "https://your-demo.vercel.app",
    saveProjectButton: "SAVE",
    savingProjectButton: "SAVING...",
    submitProjectButton: "SUBMIT PROJECT",
    submittingProjectButton: "SUBMITTING...",
    submitConfirmTitle: "Submit for judging?",
    submitConfirmSubtitle: "Review these points before you send your project.",
    submitConfirmWarnings: [
      "Organizers will use this GitHub link for demo day and judging.",
      "The repository must be public so judges can review your code.",
      "Double-check the URL — make sure it points to the correct repo.",
      "Your whole team should agree this is the project you're submitting.",
    ],
    submitConfirmGithubLabel: "GITHUB REPO TO SUBMIT",
    submitConfirmCancel: "GO BACK",
    submitConfirmConfirm: "SUBMIT PROJECT",
    submitConfirmConfirming: "SUBMITTING...",
    projectSavedBanner: "Project saved.",
    projectSubmittedBanner: "Project submitted for judging!",
    ...
    errors: {
      ...
      notCaptain: "Only the team captain can submit a project.",
  ...
  onsiteSelection: {
    ...
    boostButtonMaxed: "DAILY LIMIT — COME BACK TOMORROW",
    boostTapHint: "100 taps per day — first tap gives 3× weight, each extra adds +1",
    boostDailyProgress: "{count}/{limit} taps today",
    boostCooldownHint: "Resets at midnight — come back tomorrow",
    boosting: "SAVING...",
    ...
    errors: {
      ...
      boostLimitReached: "You've used all 100 boost taps for today. Come back tomorrow.",
      generic: "Something went wrong. Try again.",
    },
  },
  legal: {
