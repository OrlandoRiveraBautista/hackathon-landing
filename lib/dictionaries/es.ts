...
const dictionary: Dictionary = {
  ...
  shirt: {
    label: "SWAG OFICIAL",
    title: "Tu playera del",
    accentWord: "Hackathon",
    body: "Cada participante presencial recibe una playera exclusiva de Build Pa'l Norte. Elige tu talla al impulsar tu lugar — o al unirte a la lista de espera.",
    hint: "Corte unisex · Tallas XS a XXL",
    sizeLabel: "ELIGE TU TALLA",
    saveButton: "GUARDAR TALLA",
    savingButton: "GUARDANDO…",
    savedMessage: "Talla guardada — ¡listo!",
    registerCta: "ÚNETE A LA LISTA",
    registerHint: "Elegirás tu talla durante el registro.",
    signInPrompt: "Inicia sesión para guardar tu talla.",
    signInCta: "INICIAR SESIÓN",
    currentSize: "Guardada: {size}",
    expandImage: "Ver diseño de playera en pantalla completa",
    closeImage: "Cerrar",
  },
  perks: {
  ...
  waitlist: {
    ...
    shirtSizePlaceholder: "Selecciona tu talla",
    join: "REGISTRARME",
    joining: "REGISTRANDO...",
    close: "CERRAR",
    ...
    errors: {
      ...
      invalidShirtSize: "Por favor selecciona tu talla de playera.",
  ...
  members: {
    ...
    profileCompletion: {
      ...
      completeLabel:
        "Tu perfil se ve bien — ya estás listo para ser descubierto.",
      ...
      items: [
        {
          ...
          title: "Tu perfil",
          description:
            "Consulta y edita tu info, habilidades y estado de equipo.",
        },
        {
          id: "directory",
          title: "Directorio de miembros",
          description:
            "Explora builders por intereses, habilidades y disponibilidad.",
        },
        {
          id: "team",
          title: "Mi equipo",
          description:
            "Crea un equipo, envía invitaciones y administra tu crew.",
        },
        {
          id: "submit",
          title: "Entrega de proyecto",
          description:
            "Comparte tu repo y demo cuando llegue el día del hackathon.",
          comingSoon: true,
        },
      ],
    },
    directory: {
      metaTitle: "Directorio de miembros — Build Pa'l Norte",
      metaDescription:
        "Explora participantes del hackathon por nombre, habilidades, intereses y disponibilidad.",
      title: "Directorio de miembros",
      subtitle:
        "Encuentra builders con quien colaborar. Busca por nombre, escuela, habilidades o intereses.",
      searchPlaceholder: "Buscar miembros…",
      searchAriaLabel: "Buscar en el directorio de miembros",
      clearSearch: "Limpiar búsqueda",
      noResults: "Ningún miembro coincide con tu búsqueda.",
      noResultsHint: "Prueba con otro nombre, habilidad o interés.",
      resultsCount: "{count} builders",
      resultsCountOne: "1 builder",
      viewProfile: "Ver perfil",
      loading: "Buscando…",
      searchFailed: "La búsqueda falló. Intenta de nuevo.",
      viewAllResults: "Ver todos los resultados",
      searchHint: "Busca por nombre, habilidad, escuela o interés",
      showingResultsFor: "Resultados para “{query}”",
      sectionLabel: "BUILDERS",
      filterAll: "Todos",
      filterOpenTeams: "Buscan equipo",
      loadMore: "Cargar más builders",
      showingCount: "Mostrando {shown} de {total}",
      statSuffix: "builders",
      statSuffixOne: "builder",
      addToTeam: "Invitar al equipo",
      addingToTeam: "Enviando...",
      added: "En tu equipo",
      inviteSent: "Invitación enviada",
      alreadyInTeam: "Ya está en un equipo",
    ...
    platformFooter: {
      ...
      legalHeading: "LEGAL",
      tagline:
        "Un espacio para que los builders se conozcan, formen equipos y construyan juntos.",
      home: "Panel",
  ...
  notifications: {
    metaTitle: "Notificaciones — Build Pa'l Norte",
    metaDescription: "Invitaciones de equipo y actualizaciones de Build Pa'l Norte.",
    eyebrow: "NOTIFICACIONES",
    title: "Tus notificaciones",
    panelTitle: "NOTIFICACIONES",
    viewAll: "Ver todas las notificaciones",
    subtitle: "Revisa invitaciones de equipo. Solo puedes estar en un equipo.",
    emptyTitle: "Todo al día",
    emptySubtitle: "No tienes invitaciones de equipo pendientes.",
    inviteMessage: "{captain} te invitó a unirte a {team}",
    accept: "Aceptar",
    decline: "Rechazar",
    accepting: "Aceptando...",
    declining: "Rechazando...",
    acceptedBanner: "¡Te uniste al equipo!",
    declinedBanner: "Invitación rechazada.",
    backToHome: "← Volver al panel",
    errors: {
      generic: "Algo salió mal. Intenta de nuevo.",
      alreadyInTeam: "Ya estás en un equipo.",
      teamFull: "Ese equipo está lleno.",
      inviteExpired: "Esta invitación ya no está disponible.",
    },
  },
  profile: {
    ...
    shirtSize: "TALLA DE PLAYERA",
    shirtSizeEmpty: "Sin talla registrada",
    shirtSizeHint: "Corte unisex — la usaremos para tu playera del hackathon.",
    interests: "INTERESES",
    interestsEmpty: "Sin intereses listados.",
    openToTeams: "Abierto a equipos",
    openToTeamsHint:
      "Muestra a otros builders que buscas compañeros de equipo.",
    notOpenToTeams: "No busca equipo",
    email: "CORREO",
    phone: "TELÉFONO",
    showEmail: "Mostrar correo públicamente",
    showEmailHint:
      "Permite que otros miembros vean tu correo en tu perfil público.",
    showPhone: "Mostrar teléfono públicamente",
    showPhoneHint:
      "Permite que otros miembros vean tu teléfono en tu perfil público.",
    showPhoneDisabledHint:
      "Agrega un número de teléfono en tu registro para activar esto.",
    contactVisibilitySection: "VISIBILIDAD DE CONTACTO",
    contactPublic: "Público",
    ...
    skillsHint:
      "Presiona Enter o usa coma para agregar cada habilidad — máximo 20.",
    ...
    errors: {
      ...
      invalidShirtSize: "Selecciona una talla de playera válida.",
      generic: "Algo salió mal. Intenta de nuevo.",
      saveFailed: "No se pudo guardar tu perfil. Intenta de nuevo.",
    },
  },
  team: {
    metaTitle: "Mi equipo — Build Pa'l Norte",
    metaDescription:
      "Crea o administra tu equipo del hackathon y envía tu proyecto en Build Pa'l Norte.",
    eyebrow: "MI EQUIPO",
    noTeamTitle: "Aún no estás en un equipo",
    noTeamSubtitle:
      "Crea un equipo para organizar a tu crew y enviar su proyecto al hackathon.",
    createTeamLabel: "CREAR UN EQUIPO",
    teamNameLabel: "NOMBRE DEL EQUIPO",
    teamNamePlaceholder: "ej. Builders Atómicos",
    teamDescriptionLabel: "DESCRIPCIÓN",
    teamDescriptionPlaceholder: "¿Qué van a construir? (opcional)",
    suggestName: "Sugerir nombre",
    openToJoin: "Abierto a nuevos miembros",
    openToJoinHint: "Permite que otros builders soliciten unirse a tu equipo.",
    ...
    leavingTeam: "Saliendo...",
    projectLabel: "ENTREGA DEL PROYECTO",
    projectSubtitle:
      "Comparte tu repo de GitHub y detalles del proyecto para evaluación.",
    noProjectSubtitle:
      "Agrega tu repo de GitHub para registrar tu proyecto en el hackathon.",
    githubUrlLabel: "URL DEL REPO EN GITHUB",
    githubUrlPlaceholder: "https://github.com/tu-org/tu-repo",
    githubUrlHint: "Debe ser un repositorio público.",
    projectTitleLabel: "TÍTULO DEL PROYECTO",
    projectTitlePlaceholder: "¿Qué construyeron?",
    projectDescriptionLabel: "DESCRIPCIÓN",
    projectDescriptionPlaceholder: "¿Qué problema resuelve?",
    techStackLabel: "STACK TECNOLÓGICO",
    techStackPlaceholder: "Agregar tecnología...",
    techStackHint: "Presiona Enter o usa coma para agregar cada etiqueta.",
    demoUrlLabel: "LINK DE DEMO",
    demoUrlPlaceholder: "https://tu-demo.vercel.app",
    saveProjectButton: "GUARDAR",
    savingProjectButton: "GUARDANDO...",
    submitProjectButton: "ENVIAR PROYECTO",
    submittingProjectButton: "ENVIANDO...",
    submitConfirmTitle: "¿Enviar para evaluación?",
    submitConfirmSubtitle: "Revisa estos puntos antes de enviar tu proyecto.",
    submitConfirmWarnings: [
      "Los organizadores usarán este enlace de GitHub para demo day y evaluación.",
      "El repositorio debe ser público para que los jueces puedan revisar tu código.",
      "Verifica la URL — asegúrate de que apunte al repo correcto.",
      "Todo tu equipo debe estar de acuerdo con este envío.",
    ],
    submitConfirmGithubLabel: "REPO DE GITHUB A ENVIAR",
    submitConfirmCancel: "VOLVER",
    submitConfirmConfirm: "ENVIAR PROYECTO",
    submitConfirmConfirming: "ENVIANDO...",
    projectSavedBanner: "Proyecto guardado.",
    projectSubmittedBanner: "¡Proyecto enviado para evaluación!",
    submittedBadge: "Enviado",
    draftBadge: "Borrador",
    ...
    errors: {
      generic: "Algo salió mal. Intenta de nuevo.",
      alreadyInTeam: "Ya estás en un equipo.",
      notCaptain: "Solo el capitán puede enviar el proyecto.",
      githubRequired: "La URL del repositorio de GitHub es requerida.",
      invalidGithubRepo:
        "Ingresa una URL válida de GitHub (ej. https://github.com/user/repo).",
      captainMustTransfer:
  ...
  onsiteSelection: {
    ...
    boostButtonMaxed: "LÍMITE DIARIO — VUELVE MAÑANA",
    boostTapHint: "100 toques por día — el primero da 3× peso, cada extra suma +1",
    boostDailyProgress: "{count}/{limit} toques hoy",
    boostCooldownHint: "Se reinicia a medianoche — vuelve mañana",
    boosting: "GUARDANDO...",
    ...
    errors: {
      ...
      boostLimitReached: "Ya usaste los 100 toques de boost de hoy. Vuelve mañana.",
      generic: "Algo salió mal. Intenta de nuevo.",
    },
  },
  legal: {
